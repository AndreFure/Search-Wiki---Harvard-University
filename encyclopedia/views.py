...
# Form used in the sidebar to find the title of the entry.


class NewEntryForm(forms.Form):
    title = forms.CharField(label="Put the title of your entry here:", widget=forms.TextInput(
...
# Return the wiki entry. Error if not present.
